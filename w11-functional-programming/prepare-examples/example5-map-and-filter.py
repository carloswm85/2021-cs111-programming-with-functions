...
def main():
    ...
    # Replace all occurrrences of "AB" with "Alberta" by
...
"""
Example 5 contains a program that uses the map and filter functions. The example program works by doing the following:
	- Calling the map function at line 41 to convert all elements that are "AB" to "Alberta."
	- Calling the filter function at line 57 to remove all elements that are not "Alberta."
	- Calling the len function at line 64 to count the number of elements that remain in the filtered list.
"""
