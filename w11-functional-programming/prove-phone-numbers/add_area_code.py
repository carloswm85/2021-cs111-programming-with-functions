def main():
    try:
        phone_numbers_file = "E:/GitHub/2021-cs111-programming-with-functions/w11-functional-programming/prove-phone-numbers/phone_numbers.txt"
        # Open the file phone_numbers.txt for reading and read all
        # of the phone numbers into a list named phone_numbers.
        phone_numbers = read_list(phone_numbers_file)
