    ...
    while run:
        try:
            ...
            if filename == "accidents.csv":
                filename = "E:/GitHub/2021-cs111-programming-with-functions/w10-handling-exceptions/checkpoint-accidents/accidents.csv"
            else:
                pass
            ...
            cont = input('> Do you want to run the program again? 1 is Yes; 0 is No → ' )
            if cont == '0':
                run = False12fd
